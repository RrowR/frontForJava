...
const routes = [
  {
    ...
    children: [
      { 
        path:'c1/p1',
        component: () => import('@/views/myviews/containers2/nesting/P1View.vue')
      },
      { 
        path:'c1/p2',
        component: () => import('@/views/myviews/containers2/nesting/P2View.vue')
      },
      { 
        path:'c1/p3',
        component: () => import('@/views/myviews/containers2/nesting/P3View.vue')
      }
    ]
  },
  {
