...
const routes = [
  {
    ...
    children: [
      {
        path: 'c/p1',
        component: () => import('@/views/myviews/containers/nesting/P1View.vue'),
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'c/p2',
        component: () => import('@/views/myviews/containers/nesting/P2View.vue'),
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'c/p3',
        component: () => import('@/views/myviews/containers/nesting/P3View.vue'),
      }
    ]
  },
  {
